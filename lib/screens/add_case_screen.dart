...
class _AddCaseScreenState extends State<AddCaseScreen> {
  ...
  final TextEditingController _lawyerNameController =
      TextEditingController(); // Or "Lawyer Required"
  ...
  Future<void> _saveCase() async {
    ...
    try {
      ...
      for (var file in _selectedFiles) {
        if (file.path != null) {
          ...
          final ref = FirebaseStorage.instance
              .ref()
              .child('case_documents/${user.uid}/$fileName');
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Error saving case: $e')));
    } finally {
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: suffixIcon != null
                ? Icon(suffixIcon, color: primaryMaroon)
                : null,
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                  ...
                  maxLines: 3,
                  hint: 'Enter case details...'),
              _buildTextField(
                  label: 'Lawyer Name (Optional)',
                  controller: _lawyerNameController,
                  hint: 'Enter name or "Require Lawyer"'),
              _buildTextField(
                  label: 'Court Name / Address',
                  controller: _courtNameController,
                  hint: 'e.g., High Court Lahore'),
              _buildTextField(
